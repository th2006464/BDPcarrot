...
public class UserPopupWindow {
    ...
    public void show(Context context) {
        ...
        adapter = new UserListAdapter(context, user -> {
            try {
                delAnchor(user.getUid(), user.getName());
            } catch (JSONException e) {
                Log.e("UserPopupWindow", "delAnchor error", e);
            }
        });
        ...
        NetworkManager.getInstance().getAsync(
                ...
                new Callback() {
                    ...
                    public void onFailure(@NonNull Call call, @NonNull IOException e) {
                        Log.e("UserPopupWindow", "检测失败: " + user.getName() + " - " + e.getMessage());
                        clearCheckUid(user.getUid());
                    }
    ...
    public void delAnchor(String uid, String name) throws JSONException {
